...
alias rasp="sh $HOME/scripts/sshtomac.sh DC:A6:32:53:B9:2F"
...
alias git-head="git log -p -1"
alias note="code $HOME/Projects/notes.md"
alias clip="xclip -sel clip"
alias bkpnote="cp $HOME/Projects/notes.md notes-`date +%Y-%m-%d`.md"
alias cdavenue="cdprojects && cd Avenue"
alias cl="clear && clear"
alias wowup="screen -dmS wowup bash -c '/home/hugo/Documents/WowUp-2.3.0.AppImage'"
alias mocean="docker run -it --name mocean --device=/dev/hugepages:/dev/hugepages --device=lib/modules:/lib/modules --privileged --cap-add=ALL m-ocean"
alias ssh2mac="sh $HOME/scripts/sshtomac.sh $1"