...
alias gocmd="go run $HOME/Projects/snippets/go-snippets/gocmd.go"
...
alias lite-avd="screen -dmS lite-avd bash -c '$HOME/Android/Sdk/emulator/emulator -avd lite'"
...
alias supply="cd $HOME/go/src/bitbucket.org/supplylabsteam"
...
alias supply-code="code $HOME/go/src/bitbucket.org/supplylabsteam/supplylabs.code-workspace"
...
f=$(fortune)
alias rcommit="git commit -m'random commit: \"$f\"'"
